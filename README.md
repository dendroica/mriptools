...
## Instructions  
Below is an example R script to run the `mrip()` function to identify outliers in the preliminary year. Outlier analysis is performed with respect to a baseline timespan you set in `comparison_timespan`. Set the FIPS code for your state:  
